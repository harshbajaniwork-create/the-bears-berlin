    ...
    <section className="bg-white dark:bg-black">
      <div className="min-h-screen  text-black dark:text-white px-6 py-28 max-w-3xl mx-auto">
        ...
        <p className="mb-4">
          ...
          of the German Telemedia Act (TMG). According to §§ 8 to 10 TMG, we are
          ...
          Obligations to remove or block the use of information remain
          unaffected. However, liability is only possible from the time of
        ...
        <p className="mb-4">
          ...
          operator is always responsible for the contents of the linked pages.
          At the time of linking, these pages were checked for possible legal
          violations. Illegal content was not recognizable at that time.
          Permanent monitoring is not reasonable without specific indications of
          a violation. Upon becoming aware of such violations, we will remove
        ...
        <p className="mb-4">
          ...
          permitted only for private, non-commercial use. Third-party content is
          marked as such. If you become aware of any copyright infringement,
          please inform us. Upon becoming aware, we will remove such content
          immediately.
        </p>
